 ...
 */
package com.qt.maint.common.entity.search.utils;

import com.google.common.collect.Lists;
import com.qt.maint.common.entity.search.SearchOperator;
import com.qt.maint.common.entity.search.Searchable;
import com.qt.maint.common.entity.search.exception.InvalidSearchPropertyException;
import com.qt.maint.common.entity.search.exception.InvalidSearchValueException;
import com.qt.maint.common.entity.search.exception.SearchException;
import com.qt.maint.common.entity.search.filter.AndCondition;
import com.qt.maint.common.entity.search.filter.Condition;
import com.qt.maint.common.entity.search.filter.OrCondition;
import com.qt.maint.common.entity.search.filter.SearchFilter;
import com.qt.maint.common.utils.SpringUtils;
...
public final class SearchableConvertUtils {
     ...
     * value="com.qt.maint.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.qt.maint.common.entity.search.utils." +
